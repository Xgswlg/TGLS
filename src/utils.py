...
class Preprocessor:
    ...
    def split_into_short_samples(self, sample_list, max_seq_len, sliding_len = 50, encoder = "BiLSTM", data_type = "train"):
        new_sample_list = []
        for sample in tqdm(sample_list, desc = "Splitting into subtexts"):
            ...
            for start_ind in range(0, len(tokens), sliding_len):
                ...
                sub_pos_list = pos_list[start_ind:end_ind]
                sub_lemma_list = lemma_list[start_ind:end_ind]
                ...
                new_sample = {
                    ...
                    "lemma_list": sub_lemma_list,
                    "pos_list": sub_pos_list
                    }
                if data_type == "train":
                    new_sample["lang"] = lang
